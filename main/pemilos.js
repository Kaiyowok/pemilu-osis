                ...
                candidateDiv.innerHTML = `
                    <div class="candidate-card card" data-candidate-id="${candidate.id}">
                        <div class="card-header text-center" style="position: relative; padding-bottom: 1.5rem;">
                            ...
                            <img src="/assets/${candidate.nama}.png" alt="${candidate.nama}" class="candidate-photo" onerror="this.onerror=null; this.style.display='none'; this.nextElementSibling.style.display='flex';">
